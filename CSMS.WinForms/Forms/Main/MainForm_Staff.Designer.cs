namespace CSMS.WinForms.Forms.Main
{
    partial class MainForm_Staff
    {
		...
		private void InitializeComponent()
		{
			...
			tableLayoutPanel2.Size = new Size(134, 334);
			...
			ManagementSystem.Location = new Point(3, 31);
			ManagementSystem.Name = "ManagementSystem";
			ManagementSystem.Size = new Size(122, 31);
			...
			tableLayoutPanel4.RowStyles.Add(new RowStyle(SizeType.Absolute, 15F));
			tableLayoutPanel4.RowStyles.Add(new RowStyle(SizeType.Absolute, 15F));
			tableLayoutPanel4.Size = new Size(128, 264);
			...
			DashboardBut.Location = new Point(3, 2);
			DashboardBut.Margin = new Padding(3, 2, 3, 2);
			DashboardBut.Name = "DashboardBut";
			DashboardBut.Size = new Size(124, 22);
			...
			PosBut.Location = new Point(3, 28);
			PosBut.Margin = new Padding(3, 2, 3, 2);
			PosBut.Name = "PosBut";
			PosBut.Size = new Size(124, 22);
			PosBut.TabIndex = 1;
			PosBut.Text = "POS";
			...
			ProductBut.Location = new Point(3, 54);
			ProductBut.Margin = new Padding(3, 2, 3, 2);
			ProductBut.Name = "ProductBut";
			ProductBut.Size = new Size(124, 22);
			...
			InventoryBut.Location = new Point(3, 80);
			InventoryBut.Margin = new Padding(3, 2, 3, 2);
			InventoryBut.Name = "InventoryBut";
			InventoryBut.Size = new Size(124, 22);
			...
			tableLayoutPanel5.Location = new Point(143, 2);
			...
			tableLayoutPanel5.Size = new Size(554, 334);
			...
			tableLayoutPanel6.Size = new Size(548, 29);
			...
			staff.Location = new Point(386, 0);
			staff.Name = "staff";
			staff.Size = new Size(114, 29);
			staff.TabIndex = 0;
			staff.Text = "Staff";
			...
			logout.Location = new Point(506, 2);
			logout.Margin = new Padding(3, 2, 3, 2);
			logout.Name = "logout";
			logout.Size = new Size(39, 25);
			logout.TabIndex = 1;
			logout.Text = "Logout";
			...
			tableLayoutPanel7.Size = new Size(377, 25);
			...
			Search.Location = new Point(342, 2);
			Search.Margin = new Padding(3, 2, 3, 2);
			Search.Name = "Search";
			Search.Size = new Size(32, 21);
			Search.TabIndex = 1;
			Search.Text = "Search";
			...
			pnlContent.Location = new Point(3, 35);
			pnlContent.Margin = new Padding(3, 2, 3, 2);
			pnlContent.Name = "pnlContent";
			pnlContent.Size = new Size(548, 297);
